        ...
        return (
          <span
            ...
            className={`px-2 py-0.5 rounded text-sm font-medium ${
              match ? 'bg-green-100 text-[#10B981]' : 'bg-red-100 text-[#EF4444]'
            }`}
          >
            {cw}
          </span>
    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="flex flex-col items-center mb-6">
        <button
          ...
          className="w-20 h-20 rounded-full bg-[#2563EB] text-white flex items-center justify-center shadow-lg hover:bg-blue-700 transition-colors active:scale-95"
          title="Nghe lại"
        >
        ...
        <p className="text-[#64748B] text-xs mt-3">Bấm để nghe</p>
      </div>
