...
const PUBLIC_PATHS = ['/', '/login', '/register', '/blog', '/courses', '/roadmap', '/store', '/api/auth', '/api/blog', '/api/leaderboard', '/leaderboard', '/forgot-password', '/practice']
...
export const config = {
  matcher: [
    '/((?!_next/static|_next/image|favicon.ico|sw\\.js|workbox-|swe-worker-|manifest\\.json|icon-|apple-touch-icon|robots\\.txt|sitemap\\.xml).*)',
  ],
}
